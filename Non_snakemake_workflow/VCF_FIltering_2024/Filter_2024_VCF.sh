...
vcftools --vcf $vcf_file --maf $MAF --max-missing $missing --minDP $depth --maxDP $maxdepth --recode --out /home/darrian/Desktop/UGA/Wallace_Lab/Mapping_and_QTL/Data/VCF/all_snps_filtered
